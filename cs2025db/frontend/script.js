...
// write a if statment to search for a drama //
        ...
        if(drama.Title.toLowerCase().includes(input.toLowerCase()) || drama.language.toLowerCase().includes(input.toLowerCase())){
            let frontContent = `
                ...
                let backContent = `
					...
					<a href = "${drama.review}" target="_blank" >TRAILER</a> 
                `;
...
// look for the w3 school to get the flip card function//
...
//if u click the filp card the information will appear in the right panel//
//we create a function called rightInfo//
